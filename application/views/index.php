                    ...
                    <div class="modal-body">
                        ...
                        <div class="ms_register_form">
                            ...
                            <div class="form-group">
                                <input type="text" name="txtuname" required="" placeholder="Enter Username" class="form-control">
                                <span class="form_icon">
                                <i class="fa_icon form-user" aria-hidden="true"></i>
                                </span>
                            </div>
                            <div class="form-group">
                                <input type="Password" name="txtpwd" required="" class="form-control" placeholder="Enter Password">
                                <span class="form_icon">
                            ...
                            <div class="form-group">
                                <input type="text" name="txtemail" class="form-control" required="" placeholder="Enter Email">
                                <span class="form_icon">
                                <i class="fa_icon form-envelope" aria-hidden="true"></i>
                                </span>
                            </div>
                            <div class="form-group">
                                <input type="file" name="txtpropic" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" name="txtcontact" required="" class="form-control" placeholder="Enter Contact Number">
                            </div>
                            <div class="form-group">
                                <input type="date" name="txtdob" required="" class="form-control" placeholder="Date Of Birth">        
                            </div>
                            <div class="form-group">
                                <input type="text" name="txtgender" required="" class="form-control" placeholder="Enter Gender">
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="ms_register_form">
                            <h2>login / Sign in</h2>
                            <div class="form-group">
                                <input type="text" required="" placeholder="Enter Username" class="form-control" name="username">
                                <span class="form_icon">
                            <i class="fa_icon form-user" aria-hidden="true"></i>
                        </span>
                            </div>
