		...
		<div class="pcoded-inner-content">
			...
			<center>
				...
				<form method="post" enctype="multipart/form-data" action="<?= site_url("Musicadmin_c/Displaysong_c/addsong");?>">
					<div class="form-group row">
						...
						<select name="selalbumid" class="col-sm-10">
							<option value="-1" required="">Select Album</option>
							<?php
								foreach($al as $key)
								{
							?>	
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<input type="file" required="" class="form-control" name="songFile" placeholder="">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
 					<input type="text" required="" class="form-control" name="txtduration" placeholder="">	
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Status</label>
					<div class="col-sm-10">
 					<input type="text" required="" class="form-control" name="txtstatus" placeholder="">	
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Description</label>
					<div class="col-sm-10">
 					<input type="text" required="" class="form-control" name="txtdescription" placeholder="">	
					</div>
				</div>
				<div class="form-group row">
