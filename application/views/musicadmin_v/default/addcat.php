		...
		<div class="pcoded-inner-content">
			...
			<center>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<input type="text" required="" class="form-control" placeholder="Type your title in Placeholder">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
 					<input type="password" required="" class="form-control" placeholder="Password input">	
					</div>
				</div>
